  ...
  return (
    <section className="relative h-[500px] md:min-h-screen md:h-auto flex flex-col items-center justify-center md:justify-center text-white text-center px-4 md:px-[40px] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full items-center justify-center py-10 md:py-0 md:gap-[163px]">
        {/* Upper Tagline */}
        <div className="w-full max-w-[350px] md:max-w-none">
          <h2
            className="font-[family-name:var(--font-inter)] font-[700] text-[35px] md:text-[66px] leading-[120%] tracking-[-0.5px] md:tracking-[-1.46px] text-center"
          >
        ...
        {/* Lower Section Text */}
        <div
          className="mt-auto md:mt-0 font-[family-name:var(--font-inter-display)] text-center tracking-[-0.5px] font-[400] text-[20px] md:text-[50px] leading-[100%] flex items-center justify-center gap-2 md:gap-4 w-full md:max-w-none"
        >
