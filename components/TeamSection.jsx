export default function TeamSection() {
  const team = [
    ...
    },
    {
      name: "Anushka",
      role: "Program Lead",
      image: "/team/anushka_kairana.png",
      scale: "scale-140",
    },
    ...
    <section className="bg-[#F6F6F6] text-black">
      <div className="mx-auto px-10 py-20 lg:py-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[460px_1fr] gap-10 lg:gap-20">
          {/* LEFT */}
          <h2 className="text-5xl font-medium tracking-[-2px] text-black">
            The Tribe
          </h2>

          {/* RIGHT */}
          <div>
            <p className="text-sm text-[21px] tracking-[-1.2px] font-medium text-[#333336] mb-4">
              We hate company politics
            </p>

            <p className="text-[35px] font-medium tracking-[-1.4px] leading-[120%] text-[#8A8A91] ">
        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-[460px_1fr] gap-10 lg:gap-20">
          {/* LEFT EMPTY COLUMN */}
          <div />
      ...
      <section className="">
        <div className="mx-auto px-6 py-20 lg:py-24">
          {/* SAME GRID AS ABOVE (IMPORTANT) */}

          {/* RIGHT CONTENT */}
          <div className="flex justify-center items-center gap-6 lg:gap-10">
            {/* TITLE */}
            <h3 className="text-3xl lg:text-[32px] font-serif text-[#8A8A91] tracking-[-1.2px]">
              Join the Team
            </h3>
            ...
            <div className="flex items-center gap-8 text-lg">
              <a
                href="#"
                className="group relative font-medium text-[28px] tracking-[-1.2px] text-[#333336] hover:text-[#C01522] transition"
              >
                career page
